...
import { createContext, useState, useRef, useMemo, useContext, forwardRef, useCallback, useEffect } from 'react';
...
const AudioPlayerContext = createContext(void 0);
function AudioPlayerContextProvider(props) {
  ...
  return /* @__PURE__ */ jsx(AudioPlayerContext.Provider, { value: contextValue, children });
}
...
const ForwardRef$f = forwardRef(SvgStarLine);
...
const ForwardRef$e = forwardRef(SvgForwardEndFill);
...
const ForwardRef$d = forwardRef(SvgPauseLargeFill);
...
const ForwardRef$c = forwardRef(SvgPlayLargeFill);
...
const ForwardRef$b = forwardRef(SvgRewindFill);
...
const ForwardRef$a = forwardRef(SvgRewindStartFill);
...
const ForwardRef$9 = forwardRef(SvgShuffleFill);
...
const ForwardRef$8 = forwardRef(SvgSpeedFill);
...
const ForwardRef$7 = forwardRef(SvgStopLargeFill);
...
const ForwardRef$6 = forwardRef(SvgVolumeMuteFill);
...
const ForwardRef$5 = forwardRef(SvgVolumeDownFill);
...
const ForwardRef$4 = forwardRef(SvgVolumeUpFill);
...
const ForwardRef$3 = forwardRef(SvgRepeatFill);
...
const ForwardRef$2 = forwardRef(SvgRepeatOneFill);
...
const ForwardRef$1 = forwardRef(SvgRepeat2Fill);
...
const icons = {
  "star-line": ForwardRef$f,
  "forward-end-fill": ForwardRef$e,
  "pause-large-fill": ForwardRef$d,
  "play-large-fill": ForwardRef$c,
  "repeat-fill": ForwardRef$3,
  "repeat-one-fill": ForwardRef$2,
  "repeat-2-fill": ForwardRef$1,
  "rewind-fill": ForwardRef$b,
  "rewind-start-fill": ForwardRef$a,
  "shuffle-fill": ForwardRef$9,
  "speed-fill": ForwardRef$8,
  "stop-large-fill": ForwardRef$7,
  "volume-mute-fill": ForwardRef$6,
  "volume-down-fill": ForwardRef$5,
  "volume-up-fill": ForwardRef$4,
...
function _Icon(props, ref) {
  ...
  return /* @__PURE__ */ jsx(
    Icon2,
    {
      className: twMerge(clsx$1("h-[1em] fill-current", className)),
      ...restProps,
      ref
    }
  );
...
function AudioPlayerControlsBase(props) {
  const { as = "div", children, className, ...restProps } = props;
  const Node = as;
  return /* @__PURE__ */ jsx(
    Node,
    {
      className: twMerge(clsx$1("flex justify-center gap-4 items-center text-2xl p-4", className)),
      ...restProps,
      children
    }
  );
...
function AudioPlayerControlsButtonPlay(props) {
  ...
  return /* @__PURE__ */ jsx("button", { ...restProps, children: active ? /* @__PURE__ */ jsx(Icon, { name: "pause-large-fill" }) : /* @__PURE__ */ jsx(Icon, { name: "play-large-fill" }) });
}
function AudioPlayerControlsButtonLoop(props) {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      className: twMerge(
        clsx$1({ "text-neutral-100/50": !active }, "hover:text-neutral-100", className)
      ),
      ...restProps,
...
function AudioPlayerControlsButtonShuffle(props) {
  const { active = false, className, ...restProps } = props;
  return /* @__PURE__ */ jsx(
    "button",
    {
...
function AudioPlayerControlsButtonPrevious(props) {
  return /* @__PURE__ */ jsx("button", { ...props, children: /* @__PURE__ */ jsx(
    Icon,
    {
...
function AudioPlayerControlsButtonNext(props) {
  return /* @__PURE__ */ jsx("button", { ...props, children: /* @__PURE__ */ jsx(
    Icon,
    {
...
function AudioPlayerControls(props) {
  ...
  return /* @__PURE__ */ jsxs(AudioPlayerControlsBase, { ...props, children: [
    /* @__PURE__ */ jsx(
      "audio",
      {
    ...
    /* @__PURE__ */ jsx(AudioPlayerControlsButtonPrevious, { onClick: handlePrevTrack }),
    /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx(AudioPlayerControlsButtonNext, { onClick: handleNextTrack }),
    /* @__PURE__ */ jsx(
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        !src && /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-full h-full", children: /* @__PURE__ */ jsx("span", { className: "text-4xl", children: /* @__PURE__ */ jsx(Icon, { name: "disc-fill" }) }) })
      ]
    }
  );
}
...
function AudioPlayerInfo(props) {
  ...
  return /* @__PURE__ */ jsx(
    Node,
    {
      className: twMerge(clsx$1("flex items-center gap-4", className)),
      ...restProps,
      children
    }
  );
...
function AudioPlayerTime(props) {
  ...
  return /* @__PURE__ */ jsxs(
    Node,
    {
      className: twMerge(clsx$1("text-sm", className)),
      ...restProps,
      children: [
        currentTimeForDisplay,
        " / ",
        durationForDisplay
      ]
    }
...
function AudioPlayerVolumeLayout(props) {
  const { as = "div", className, children, onChange, onClick, value, ...restProps } = props;
  const Node = as;
  return /* @__PURE__ */ jsxs(
    Node,
    {
      className: twMerge(clsx$1("flex items-center gap-3", className)),
      ...restProps,
      children: [
        /* @__PURE__ */ jsx(
          "button",
  ...
  if (mute || volume < 5) {
    return /* @__PURE__ */ jsx(
      AudioPlayerVolumeLayout,
      {
        ...
        value: volume,
        children: /* @__PURE__ */ jsx(Icon, { name: "volume-mute-fill" })
      }
    );
  }
  if (volume >= 40) {
    return /* @__PURE__ */ jsx(
      AudioPlayerVolumeLayout,
      {
        ...
        onChange: handleVolumeChange,
        value: volume,
        children: /* @__PURE__ */ jsx(Icon, { name: "volume-up-fill" })
      }
    );
  }
  return /* @__PURE__ */ jsx(
    AudioPlayerVolumeLayout,
    {
      ...
      onChange: handleVolumeChange,
      value: volume,
      children: /* @__PURE__ */ jsx(Icon, { name: "volume-down-fill" })
    }
  );
}
...
function AudioPlayer(props) {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      className: twMerge(
        clsx$1("bg-slate-700 flex flex-col justify-center text-neutral-100", className)
      ),
      children
    }
  );
...
export { AudioPlayer, AudioPlayerAuthor, AudioPlayerAuthorBase, AudioPlayerContext, AudioPlayerContextProvider, AudioPlayerControls, AudioPlayerControlsBase, AudioPlayerControlsButtonLoop, AudioPlayerControlsButtonNext, AudioPlayerControlsButtonPlay, AudioPlayerControlsButtonPrevious, AudioPlayerControlsButtonShuffle, AudioPlayerImage, AudioPlayerImageBase, AudioPlayerInfo, AudioPlayerProgressBar, AudioPlayerProgressBarBase, AudioPlayerTime, AudioPlayerTitle, AudioPlayerTitleBase, AudioPlayerVolume, Badge, Button, Icon, formatAudioDurationForDisplay, useAudioPlayerContext, useAudioPlayerControls, useAudioPlayerProgressBar };
