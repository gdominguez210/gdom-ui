...
import { createContext, useContext, useRef, useMemo, useReducer, useCallback, forwardRef, useEffect } from 'react';
...
const ForwardRef$h = forwardRef(SvgStarLine);
...
const ForwardRef$g = forwardRef(SvgForwardEndFill);
...
const ForwardRef$f = forwardRef(SvgPauseLargeFill);
...
const ForwardRef$e = forwardRef(SvgPlayLargeFill);
...
const ForwardRef$d = forwardRef(SvgRewindFill);
...
const ForwardRef$c = forwardRef(SvgRewindStartFill);
...
const ForwardRef$b = forwardRef(SvgShuffleFill);
...
const ForwardRef$a = forwardRef(SvgSpeedFill);
...
const ForwardRef$9 = forwardRef(SvgStopLargeFill);
...
const ForwardRef$8 = forwardRef(SvgVolumeMuteFill);
...
const ForwardRef$7 = forwardRef(SvgVolumeDownFill);
...
const ForwardRef$6 = forwardRef(SvgVolumeUpFill);
...
const ForwardRef$5 = forwardRef(SvgRepeatFill);
...
const ForwardRef$4 = forwardRef(SvgRepeatOneFill);
...
const ForwardRef$3 = forwardRef(SvgRepeat2Fill);
...
const ForwardRef$2 = forwardRef(SvgDiscFill);
...
const ForwardRef$1 = forwardRef(SvgPlayList2Fill);
...
const ForwardRef = forwardRef(SvgPlayListAddFill);
...
function AudioPlayerControls(props) {
  return /* @__PURE__ */ jsxs(AudioPlayerControlsPrimitive, { ...props, children: [
    /* @__PURE__ */ jsx(AudioPlayerControlAudio, {}),
    /* @__PURE__ */ jsx(AudioPlayerControlLoop, {}),
    /* @__PURE__ */ jsx(AudioPlayerControlPrevious, {}),
    /* @__PURE__ */ jsx(AudioPlayerControlPlay, {}),
    /* @__PURE__ */ jsx(AudioPlayerControlNext, {}),
    /* @__PURE__ */ jsx(AudioPlayerControlShuffle, {})
  ] });
}
...
function AudioPlayerVolume(props) {
  return /* @__PURE__ */ jsxs(AudioPlayerVolumePrimitive, { ...props, children: [
    /* @__PURE__ */ jsx(AudioPlayerVolumeButton, {}),
    /* @__PURE__ */ jsx(AudioPlayerVolumeSlider, {})
  ] });
}
...
function AudioPlayer(props) {
  ...
  return /* @__PURE__ */ jsx(
    AudioPlayerContextProvider,
    {
      ...
      defaultTrackIndex,
      defaultVolume,
      children: /* @__PURE__ */ jsx(AudioPlayerPrimitive, { ...restProps })
    }
  );
}
...
export { AudioPlayerCompoundComponent as AudioPlayer, AudioPlayerAuthor, AudioPlayerAuthorPrimitive, AudioPlayerContextAudioProvider, AudioPlayerContextProvider, AudioPlayerContextRefsProvider, AudioPlayerContextTimeProvider, AudioPlayerContextTrackProvider, AudioPlayerControls, AudioPlayerControlsPrimitive, AudioPlayerImage, AudioPlayerImagePrimitive, AudioPlayerInfo, AudioPlayerPrimitive, AudioPlayerProgressBar, AudioPlayerProgressBarPrimitive, AudioPlayerTime, AudioPlayerTimePrimitive, AudioPlayerTitle, AudioPlayerTitlePrimitive, AudioPlayerVolume, AudioPlayerVolumePrimitive, Badge, Button, Icon, useAudioPlayerContextAudio, useAudioPlayerContextRefs, useAudioPlayerContextTime, useAudioPlayerContextTrack, useAudioPlayerProgressBar, useAudioPlayerTime };
