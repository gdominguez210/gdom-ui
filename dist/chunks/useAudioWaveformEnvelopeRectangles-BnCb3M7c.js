...
import { u as useAudioResponsiveSamplingEnvelopes } from './useAudioResponsiveSamplingEnvelopes-Cs-92Wuj.js';
...
function useAudioWaveformEnvelopeRectangles(props) {
  ...
  const { getSegments, getSegmentWidth, getGapWidth, calculateSegments } = useAudioResponsiveSamplingEnvelopes({
    data,
    segmentMinWidth,
    gapWidthPercent,
    gapMinWidth,
...
export { useAudioWaveformEnvelopeRectangles as u };
