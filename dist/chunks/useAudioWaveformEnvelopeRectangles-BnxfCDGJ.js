...
const useAudioResponsiveSamplingEnvelopes = require('./useAudioResponsiveSamplingEnvelopes-Byl6PVnB.js');
...
function useAudioWaveformEnvelopeRectangles(props) {
  ...
  const { getSegments, getSegmentWidth, getGapWidth, calculateSegments } = useAudioResponsiveSamplingEnvelopes.useAudioResponsiveSamplingEnvelopes({
    data,
    segmentMinWidth,
    gapWidthPercent,
    gapMinWidth,
  ...
  }, [canvasRef, color, heightScale, getSegments, getSegmentWidth, getGapWidth, getColorString]);
...
exports.useAudioWaveformEnvelopeRectangles = useAudioWaveformEnvelopeRectangles;
