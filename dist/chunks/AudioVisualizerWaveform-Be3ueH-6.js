...
const index = require('./index-BLuWXMfD.js');
...
const AudioVisualizerCanvas = require('./AudioVisualizerCanvas-C-QwVlKa.js');
...
function applySegmentColor(ctx, segmentStartIndex, dataArray, currentColor, colorMode) {
  ...
  switch (colorMode) {
    case WAVEFORM_COLOR_MODES.AMPLITUDE:
      ctx.strokeStyle = index.getColorByAudioIntensity(currentColor, amplitudeRatio);
      break;
    case WAVEFORM_COLOR_MODES.FREQUENCY:
      ctx.strokeStyle = index.getColorByFrequencyPosition(currentColor, positionRatio);
      break;
    case WAVEFORM_COLOR_MODES.SPECTRUM:
      ctx.strokeStyle = index.getColorBySpectrum(currentColor, positionRatio);
      break;
    case WAVEFORM_COLOR_MODES.DYNAMIC:
      ctx.strokeStyle = index.getColorByDynamicIntensity(currentColor, amplitudeRatio);
      break;
  }
}
