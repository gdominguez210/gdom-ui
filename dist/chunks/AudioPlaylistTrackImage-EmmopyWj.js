...
const AudioPlayerImagePrimitive = require('./AudioPlayerImagePrimitive-DE8abu8O.js');
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "group relative h-12 w-12 shrink-0 overflow-hidden rounded-md", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      AudioPlayerImagePrimitive.AudioPlayerImagePrimitive,
      {
        ...
        width,
        height,
        className: bundleMjs.clsx("h-full w-full rounded-md", { "border-2 border-white": active }, className),
        ...restProps
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        className: bundleMjs.clsx("absolute inset-0 flex items-center justify-center transition-opacity", {
          "opacity-100": active,
