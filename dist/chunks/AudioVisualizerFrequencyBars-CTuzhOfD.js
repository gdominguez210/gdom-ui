...
function getBarColor(currentColor, colorMode, positionRatio, intensityRatio) {
  switch (colorMode) {
    case FREQUENCY_BARS_COLOR_MODES.FREQUENCY:
      return index.getColorByFrequencyPosition(currentColor, positionRatio);
    case FREQUENCY_BARS_COLOR_MODES.INTENSITY:
      return index.getColorByAudioIntensity(currentColor, intensityRatio);
    case FREQUENCY_BARS_COLOR_MODES.SPECTRUM:
      return index.getColorBySpectrum(currentColor, positionRatio);
    case FREQUENCY_BARS_COLOR_MODES.DYNAMIC:
      return index.getColorByDynamicIntensity(currentColor, intensityRatio);
  }
}
