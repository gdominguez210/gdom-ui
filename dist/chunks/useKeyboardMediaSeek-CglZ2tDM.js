...
const index = require('./index-CG8pgKOh.js');
...
function useKeyboardMediaSeek({
  ...
  const a11yProps = {
    ...
    "aria-valuetext": `${index.formatDurationForDisplay(mediaRef.current?.currentTime || 0)} of ${index.formatDurationForDisplay(duration)}`
  };
  return {
