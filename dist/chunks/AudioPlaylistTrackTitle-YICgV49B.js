...
const AudioPlayerTitlePrimitive = require('./AudioPlayerTitlePrimitive-Bwq312Nf.js');
...
function AudioPlaylistTrackTitlePrimitive(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      as,
      className: bundleMjs.twMerge(bundleMjs.clsx("text-sm leading-tight font-medium", className)),
      ...restProps,
      children
    }
  );
