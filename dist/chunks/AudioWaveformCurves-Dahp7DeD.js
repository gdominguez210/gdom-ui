...
const useAudioResponsiveSamplingCurves = require('./useAudioResponsiveSamplingCurves-B7uh3_si.js');
...
function useAudioWaveformCurves(props) {
  ...
  const { getValues, getSegmentWidth, calculateSegments } = useAudioResponsiveSamplingCurves.useAudioResponsiveSamplingForCurves({
    data,
    segmentMinWidth,
    interpolationFn
  });
