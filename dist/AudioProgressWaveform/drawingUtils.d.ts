...
import { WaveformGradientStop } from '../AudioWaveform/types';
import { MousePosition } from '../useMousePositionRef/useMousePositionRef';
import { ElementDimensions } from '../useElementDimensions/useElementDimensions';
/**
 ...
 */
export declare function generateGradientStops(progressColorOKLCH: OKLCHColor, progressColorCSS: string, lightnessDelta?: number): WaveformGradientStop[];
/**
 ...
 */
export declare function calculateBarCoverage(barInfo: {
    position: number;
    width: number;
 ...
 */
export declare function getNormalizedHoverPosition(mousePosition: MousePosition | undefined, dimensions: ElementDimensions | undefined): number | undefined;
