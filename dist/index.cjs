...
function AudioPlayerContextPlaybackProvider(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(AudioPlayerContextPlayback.Provider, { value: contextValue, children });
}
...
function useAudioPlayerContextPlayback() {
  const context = React.useContext(AudioPlayerContextPlayback);
  if (!context) {
...
function useAudioContextWebAPI(options) {
  ...
  const sourceNodesRef = React.useRef(/* @__PURE__ */ new Map());
  const createAudioSource = React.useCallback(
    (audioElement) => {
  ...
  const deleteAudioSource = React.useCallback((audioElement) => {
    const sourceNodes = sourceNodesRef.current;
    if (!audioElement) {
...
const AudioContext$1 = React.createContext(null);
...
function AudioContextProvider(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(AudioContext$1.Provider, { value: contextValue, children });
}
...
function useAudioContext() {
  const context = React.useContext(AudioContext$1);
  if (context === null) {
...
function useAudioProgressWaveformColor(options) {
  ...
  const progressColorOKLCH = React.useMemo(() => convertColorToOKLCH(progressColor), [progressColor]);
  const barColorOKLCH = React.useMemo(() => convertColorToOKLCH(barColor), [barColor]);
  const progressColorCSS = React.useMemo(() => OKLCHToCSS(...progressColorOKLCH), [progressColorOKLCH]);
  const barColorCSS = React.useMemo(() => OKLCHToCSS(...barColorOKLCH), [barColorOKLCH]);
  ...
  const hoverColorCSS = React.useMemo(() => OKLCHToCSS(...hoverColorOKLCH), [hoverColorOKLCH]);
...
function AudioPlaylistTrackContextProvider(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(AudioPlaylistTrackContext.Provider, { value: contextValue, children });
}
...
exports.AudioPlayerPrimitive = AudioPlayer;
...
exports.AudioPlayerVisualizerFrequencyBars = AudioPlayerVisualizerFrequencyBars;
