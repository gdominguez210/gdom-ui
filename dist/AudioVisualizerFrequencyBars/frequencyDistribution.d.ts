 ...
 */
export declare function calculateLogarithmicDistributionDenominator(): number;
/**
 ...
 */
export declare function calculateLogarithmicIndexRatio(index: number, barCount: number): number;
/**
 ...
 */
export declare function calculateLogarithmicIndex(ratio: number, dataArrayLength: number, denominator: number): number;
/**
 ...
 */
export declare function calculateAmplifiedValue(normalizedValue: number, minHeight: number): number;
/**
 ...
 */
export declare function calculateFrequencyBandAverage(dataArray: Uint8Array, startIndex: number, endIndex: number, maxValue?: number): {
