 ...
 */
export declare function normalizeAudioValue(value: number): number;
/**
 ...
 */
export declare function calculateWaveformY(normalizedValue: number, centerY: number): number;
/**
 ...
 */
export declare function calculateAmplitudeRatio(normalizedValue: number): number;
/**
 ...
 */
export declare function calculatePositionRatio(segmentIndex: number, totalLength: number): number;
/**
 ...
 */
export declare function calculateSegmentSize(dataLength: number, segmentCount: number): number;
