...
* **.generate-audio-data:** add cli script to generate pre-computed min/max pairs of audio data for multiple zoom levels ([4584a4b](https://github.com/gdominguez210/gdom-ui/commit/4584a4bb14c425d34dbeed3d6c5a16294ffcca3f))
* **lib/AudioWaveformCurves:** add AudioWaveformCurves ([85f3e45](https://github.com/gdominguez210/gdom-ui/commit/85f3e453cdf1e4de10bbbe6fd6d45cddbd2eb55f))
* **lib/AudioWaveformEnvelopeCurves:** add AudioWaveformEnvelopeCurves ([9203bda](https://github.com/gdominguez210/gdom-ui/commit/9203bda5f92e626ce13b4104def9c6eece17c9ed))
* **lib/AudioWaveformEnvelopeLines:** add AudioWaveformEnvelopeLines ([a59ffb3](https://github.com/gdominguez210/gdom-ui/commit/a59ffb3b0efb6e82663bed92d1674b9d5a3284f3))
* **lib/AudioWaveformEnvelopeRectangles:** add AudioWaveformEnvelopeRectangles ([aec7184](https://github.com/gdominguez210/gdom-ui/commit/aec7184714403fe2c106744a6100b218b9cde71b))
* **lib/AudioWaveformLines/useAudioWaveformLines:** add useAudioWaveformLines hook ([eae231b](https://github.com/gdominguez210/gdom-ui/commit/eae231bda8f7caa71a2cc3de6eb9a189f990bf55))
* **lib/useAudioResponsiveSampling:** add useAudioResponsiveSampling ([6e1c7dd](https://github.com/gdominguez210/gdom-ui/commit/6e1c7dddd5a24e15dab88ff4495dba70cf1da16a))
* **lib/useAudioResponsiveSamplingCurves:** add useAudioResponsiveSamplingCurves ([563767c](https://github.com/gdominguez210/gdom-ui/commit/563767c99da41dcc51843532aa6f4cff57a013e4))
* **utils/audioBufferToAmplitude:** add audioBufferToAmplitude utility ([e6c329c](https://github.com/gdominguez210/gdom-ui/commit/e6c329c32f9aa548849094fe98e1635df1e2770e))
* **utils/audioBufferToWaveform:** add audioBufferToWaveform ([24ceebd](https://github.com/gdominguez210/gdom-ui/commit/24ceebd25c856339023c05aaa10f8688b7511b2a))
* **utils/calculateGapWidth:** add calculateGapWidth ([f38ef62](https://github.com/gdominguez210/gdom-ui/commit/f38ef62a8cae486a0fd5aefc59ab6acfba5c259f))
* **utils/calculateMaxSegmentsInView:** add calculateMaxSegmentsInView ([a56cad4](https://github.com/gdominguez210/gdom-ui/commit/a56cad4daa67f53f99ae41c56016ffe6944abc60))
* **utils/calculateSamplingRate:** add calculateSamplingRate ([5681bd8](https://github.com/gdominguez210/gdom-ui/commit/5681bd80370825a29347590c5ed46dfcbcacb366))
* **utils/calculateSegmentWidth:** add calculateSegmentWidth ([cf0c8cb](https://github.com/gdominguez210/gdom-ui/commit/cf0c8cb00898a9da85d6f4a07d5dfc9247638431))
* **utils/calculateSegmentWidth:** add rounding for segments to prevent anti-aliasing artifacts ([4900113](https://github.com/gdominguez210/gdom-ui/commit/49001134cff9b6518f6a0608d88c5c417fc026bf))
* **utils/calculateValidSampleRange:** add calculateValidSampleRange ([e45e58b](https://github.com/gdominguez210/gdom-ui/commit/e45e58b6393ac1b5cb99bee7574896042441a7c6))
* **utils/decodeAudioFile:** add decodeAudioFile utility ([9c54f5a](https://github.com/gdominguez210/gdom-ui/commit/9c54f5af7d680d06dfcd916205d6a114bb41f599))
* **utils/findEnvelopeInSampleRange:** add findEnvelopeInSampleRange function ([e3def75](https://github.com/gdominguez210/gdom-ui/commit/e3def7516183d79a80c072eff66a10506485f98e))
* **utils/generateAmplitudeEnvelopes:** add generateAmplitudeEnvelopes utility ([ba79137](https://github.com/gdominguez210/gdom-ui/commit/ba79137e66ebc245509ff80013c8e92d9b0188e8))
* **utils/generateWaveformPoints:** add generateWaveformPoints utility ([0198516](https://github.com/gdominguez210/gdom-ui/commit/0198516c8543661f9e6aa5e024f607c7a63d82b3))
* **utils/getInterpolatedEnvelopeCubic:** add getInterpolatedEnvelopeCubic ([212b656](https://github.com/gdominguez210/gdom-ui/commit/212b656ef9b75957b49247ca9d266e4e2e8f4758))
* **utils/getInterpolatedEnvelopeFromSegments:** add getInterpolatedEnvelopeFromSegments ([f75f233](https://github.com/gdominguez210/gdom-ui/commit/f75f23334b20eead3d9e55794226b1f5b49579d7))
* **utils/getInterpolatedEnvelopeLinear:** add getInterpolatedEnvelopeLinear ([3d4cac0](https://github.com/gdominguez210/gdom-ui/commit/3d4cac02c6f7f2f87a7d0646bb7319db86f5725a))
* **utils/getInterpolatedPeakCubic:** add getInterpolatedPeakCubic ([890d582](https://github.com/gdominguez210/gdom-ui/commit/890d582768c1788f8eb4326c8dae5219c9b979c2))
* **utils/getInterpolatedPeakLinear:** add getInterpolatedPeakLinear ([e3591ea](https://github.com/gdominguez210/gdom-ui/commit/e3591eab2af33b3c9164098d8379a344c7d1180f))
* **utils/getInterpolatedValueCubic:** add getInterpolatedValueCubic ([e58f376](https://github.com/gdominguez210/gdom-ui/commit/e58f3769af17156d6396003766390aafb38202b0))
* **utils/getInterpolatedValueLinear:** add getInterpolatedValueLinear ([b19cce9](https://github.com/gdominguez210/gdom-ui/commit/b19cce9f189ee3a66973b4836b87d869f12576cb))
* **utils/interpolateCubic:** add interpolateCubic ([65a456e](https://github.com/gdominguez210/gdom-ui/commit/65a456ef528dd06e49901bd30f293ff7e3b31999))
* **utils/interpolateLinear:** add interpolateLinear ([ea23a81](https://github.com/gdominguez210/gdom-ui/commit/ea23a8193725b45a7e4044c63ec1869ff52e411d))
* **utils/isEnvelopeSegmentArray:** add isEnvelopeSegmentArray ([e4bc334](https://github.com/gdominguez210/gdom-ui/commit/e4bc3342aee7d6da81dcba1682a2946d807e5eb8))
* **utils/processAudioFileToAmplitude:** add processAudioFileToAmplitude utility ([1f3c7bc](https://github.com/gdominguez210/gdom-ui/commit/1f3c7bcd8117773f8248e1d9d0566cafd224a99b))
* **utils/processAudioFileToWaveform:** add processAudioFileToWaveform utility ([eb429d9](https://github.com/gdominguez210/gdom-ui/commit/eb429d93b466b40c6d7a4cf5a21c6d56e26bfba9))
* **utils/sampleAudioDataByInterpolation:** add sampleAudioDataByInterpolation ([b83e7bf](https://github.com/gdominguez210/gdom-ui/commit/b83e7bfabd88c9a54af2dbf30fbb418313c92230))
* **utils/sampleAudioDataByWindow:** add sampleAudioDataByWindow ([9ca218b](https://github.com/gdominguez210/gdom-ui/commit/9ca218b5a1570b45e1d7353e19ecf177d4596bff))
* **utils/sampleEnvelopesByInterpolation:** add sampleEnvelopesByInterpolation ([760c65f](https://github.com/gdominguez210/gdom-ui/commit/760c65fcd02b41161e21c6a480a9acef31d1793c))
* **utils/sampleEnvelopesByWindow:** add sampleEnvelopesByWindow ([4447bc1](https://github.com/gdominguez210/gdom-ui/commit/4447bc13a46d97eab14782c04ace248fa2c75210))
* **utils/samplePeaksByInterpolation:** add samplePeaksByInterpolation ([232bd68](https://github.com/gdominguez210/gdom-ui/commit/232bd6828e00f003e700c0f0ade963cc47b5739d))
* **utils/samplePeaksByInterpolation:** add support for transformFn ([e61be28](https://github.com/gdominguez210/gdom-ui/commit/e61be288886f8de0d3230789547db3f825521e27))
* **utils/samplePeaksByWindow:** add samplePeaksByWindow ([3a3a7b5](https://github.com/gdominguez210/gdom-ui/commit/3a3a7b53cf0dfde21f6b93081944e397610018fe))
* **utils/samplePeaksByWindow:** add support for transformFn ([59109c8](https://github.com/gdominguez210/gdom-ui/commit/59109c8c5f7d1c05a89c174d73a1e6c856ed24fe))
* **utils/sampleRawAudioByInterpolation:** add sampleRawAudioByInterpolation ([3fc21c0](https://github.com/gdominguez210/gdom-ui/commit/3fc21c0fa8708734f22050fa40f010df0cae5135))
* **utils/sampleRawAudioByWindow:** add sampleRawAudioByWindow ([5012266](https://github.com/gdominguez210/gdom-ui/commit/5012266c9e1b7821e57ceace58cad72956dccd5e))
* **utils/scaleAmplitudeAdaptive:** add scaleAmplitudeAdaptive ([0269bbb](https://github.com/gdominguez210/gdom-ui/commit/0269bbbd7548b824796af6f93e2a625174b7c9ab))
* **utils/scaleAmplitudeCubic:** add scaleAmplitudeCubic ([8502c77](https://github.com/gdominguez210/gdom-ui/commit/8502c77e493c901acd8bb2b54610b43290d9eb59))
* **utils/scaleAmplitudeLinear:** add scaleAmplitudeLinear ([d75636e](https://github.com/gdominguez210/gdom-ui/commit/d75636e5a7b12121bceda00e9f91b8a07ff37e29))
* **utils/scaleAmplitudeLogarithmic:** add scaleAmplitudeLogarithmic ([94e5e91](https://github.com/gdominguez210/gdom-ui/commit/94e5e910cec3254b3a982ccc873d09b39d929a19))
